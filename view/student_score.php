        ...
        <div class="content-wrapper">
            ...
            <div class="content-header" id="font">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Score / ពិន្ទុសិស្ស</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                    ...
                                    <table id="example1" class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody style="font-size: 14px;" id="font">
                                            ...
                                            ?>
                                                    <tr>
                                                        <td><?= $row['class_id']; ?></td>
                                                        <td><a href="student_score_detail.php?grade_id=<?= $row['class_grade'] ?>&time_id=<?= $row['class_time'] ?>&acadyear_id=<?= $row['class_acadyear'] ?>&class_type_id=<?= $row['class_type'] ?>"><?= $row['grade_kh']; ?></a></td>
