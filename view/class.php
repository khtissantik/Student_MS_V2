        ...
        <div class="content-wrapper">
            ...
            <div class="content-header" id="font">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Class / ថ្នាក់រៀន</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            ...
                            <div class="card ">
                                ...
                                <div class="card-header p-3" id="font">
                                    ...
                                    <div class="card-tools">
                                        <a><button class="btn btn-primary mr-2 " data-toggle="modal" data-target="#create_class" type="button"><i class="nav-icon fas fa-plus"></i> បង្កើតថ្នាក់រៀន</button></a>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-3" id="font">
                                    <table id="example1" class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody style="font-size: 14px;">
                                            ...
                                            INNER JOIN tbl_teacher on tbl_class.teach_name = tbl_teacher.teach_id
                                            INNER JOIN tbl_grade on tbl_class.class_grade = tbl_grade.id
                                            INNER JOIN tbl_study_time on tbl_class.class_time = tbl_study_time.id
                                            INNER JOIN tbl_acadyear on tbl_class.class_acadyear = tbl_acadyear.id
                                            INNER JOIN tbl_status on tbl_class.status = tbl_status.id
                                            WHERE tbl_class.status = 1";
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $row['time_kh']; ?></td>
                                                        <td><?= $row['acadyear']; ?></td>
                                                        <td><?= $row['class_modify_date']; ?></td>
                                                        <td><?= $row['class_modify_by']; ?></td>
                                                        <td><a class="btn btn-primary btn-sm"><?= $row['status']; ?></a></td>
                                                        <td>
                                                            <a href="class_stu.php?grade_id=<?= $row['class_grade'] ?>&time_id=<?= $row['class_time'] ?>&acadyear_id=<?= $row['class_acadyear'] ?>&class_type_id=<?= $row['class_type'] ?>" class="btn btn-info btn-sm text-white"><i class="fas fa-eye"></i></a>
