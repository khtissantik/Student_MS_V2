    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary  elevation-4" style="background-color: #0087B2;">
         ...
         with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="attenden.php" class="nav-link active">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header" id="font">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Attendence / វត្តមានសិស្ស</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="index.php">ទំព័រដើម</a></li>
                                <li class="breadcrumb-item active">វត្តមានសិស្ស</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            ...
                            <div class="card ">
                                <div class="card-header p-3" id="font">
                                    <h3 class="card-title">កាលបរិច្ឆេទសិក្សា</h3>
                                </div>
                                    ...
                                    <table id="example1" class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody style="font-size: 14px;" id="font">
                                            ...
                                            $query = "SELECT * FROM tbl_class
                                                ...
                                                INNER JOIN tbl_student on tbl_class.class_grade = tbl_student.stu_id
                                                ...
                                                INNER JOIN tbl_acadyear on tbl_class.class_acadyear = tbl_acadyear.id WHERE tbl_class.status = 1";
                                            ...
                                            ?>
                                                    <tr>
                                                        <td><?= $row['class_id']; ?></td>
                                                        <td><a href="attenden_detail.php?grade_id=<?= $row['class_grade'] ?>&time_id=<?= $row['class_time'] ?>&acadyear_id=<?= $row['class_acadyear'] ?>&class_type_id=<?= $row['class_type'] ?>&student_id=<?= $row['student_id'] ?>"><?= $row['grade_kh']; ?></a></td>
