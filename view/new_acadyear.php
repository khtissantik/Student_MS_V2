            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item menu-open">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="new_acadyear.php" class="nav-link active">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header" id="font">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">បង្កើតឆ្នាំសិក្សាថ្មី</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="index.php">ទំព័រដើម</a></li>
                <li class="breadcrumb-item ">បង្កើតឆ្នាំសិក្សាថ្មី</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
              ...
              <div class="card ">
                ...
                <div class="card-header p-3" id="font">
                  <h3 class="card-title">ឆ្នាំសិក្សា</h3>
                  <div class="card-tools">
                    <a><button class="btn btn-primary mr-2 " data-toggle="modal" data-target="#create_detail" type="button"><i class="nav-icon fas fa-plus"></i> បន្ថែមព័ត៌មាន</button></a>
                  </div>
                </div>
      ...
      <!-- /.content -->
      <!-- end Main content academic year 1-->

      <!-- --------------------------------------------------------------------------------------------------------------------- -->
    </div>
    <?php include("../modals/add_detail.php") ?>
