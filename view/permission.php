         ...
         with font-awesome or any other icon font library -->
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="permission.php" class="nav-link active">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header" id="font">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">សិទ្ធអ្នកប្រើប្រាស់</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="index.php">ទំព័រដើម</a></li>
                <li class="breadcrumb-item ">សិទ្ធអ្នកប្រើប្រាស់</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
              ...
              <div class="card ">
                ...
                <div class="card-header p-3" id="font">
                  <h3 class="card-title">ព័ត៌មានអ្នកប្រើប្រាស់</h3>
                  <div class="card-tools">
                    <a><button class="btn btn-primary mr-2 " data-toggle="modal" data-target="#create_user" type="button"><i class="nav-icon fas fa-plus"></i> បន្ថែមអ្នកប្រើប្រាស់</button></a>
                  </div>
                </div>
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    <thead>
                      <tr style="font-size: 13px;">
                        ...
                        <th>ពាក្យសម្ងាត់</th>
                        <th>លេខទូរស័ព្ទ</th>
                        <th>សិទ្ធប្រើប្រាស់</th>
                        <th>ថ្ងៃកែទិន្នន័យចុងក្រោយ</th>
                        <th>អ្នកកែទិន្នន័យចុងក្រោយ</th>
                        <th>ស្ថានភាព</th>
                        <th>សកម្មភាព</th>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      INNER JOIN tbl_status on tbl_user.status = tbl_status.id
                      ...
                      ?>
                        ...
                        <tr style="font-size: 14px;">
                          ...
                          <td>
                            <a href="view_users.php?id=<?= $row['user_id']; ?>" class="btn btn-info btn-sm text-white"><i class="fas fa-eye"></i></a>
                            <a href="edit_users.php?id=<?= $row['user_id']; ?>" data-toggle="modal" data-target="#edit_user" class="btn btn-warning btn-sm text-white"><i class="fas fa-edit"></i></a>
                            <form action="../action/delete_users.php" method="POST" class="d-inline">
                              <button onclick="return confirm('Are you sure want to delete?')" type="submit " name="delete_user" value="<?= $row['user_id']; ?>" class="btn btn-danger btn-sm text-white"><i class="fas fa-trash"></i></button>
                            </form>
                          </td>
                        </tr>
                      <?php
