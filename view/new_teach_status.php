            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item menu-open">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="new_teach_status.php" class="nav-link active">
                      <i class="nav-icon fa fa-plus fa-lg"></i>
            ...
            <div class="col-12">
              ...
              <div class="card ">
                ...
                <div class="card-header p-3" id="font">
                  <h3 class="card-title">ស្ថានភាពគ្រូ</h3>
                  <div class="card-tools">
                    <a><button class="btn btn-primary mr-2 " data-toggle="modal" data-target="#save_teach_status" type="button"><i class="nav-icon fas fa-plus"></i> បន្ថែមព័ត៌មាន</button></a>
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <th>ល.រ</th>
                        <th>ស្ថានភាពគ្រូ</th>
                        <th>ស្ថានភាពគ្រូជាអក្សរឡាតាំង</th>
                        <th>សកម្មភាព</th>
                      </tr>
                    </thead>
                    <tbody style="font-size: 14px;">
                      <tr>
                        <?php
                        $query = "SELECT * FROM tbl_teach_status";
                        $query_run = mysqli_query($con, $query);
                        if (mysqli_num_rows($query_run) > 0) {
                          foreach ($query_run as $relateds) {
                        ?>
                            <td><?= $relateds['id']; ?></td>
                            <td><?= $relateds['teach_status_kh']; ?></td>
                            <td><?= $relateds['teach_status_en']; ?></td>
