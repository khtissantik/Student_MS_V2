        ...
        <div class="content-wrapper">
            ...
            <div class="content-header" id="font">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Subjects / មុខវិជ្ជា</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card ">
                                ...
                                <div class="card-header" id="font">
                                    ...
                                    <a><button class="btn btn-primary mr-2" data-toggle="modal" data-target="#create_subject" type="button"><i class="nav-icon fas fa-plus"></i> បង្កើតមុខវិជ្ជា</button></a>
                                    </div>
                                </div>
                                    ...
                                    <table id="example1" class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody style="font-size: 13px;">
                                            ...
                                            <?php
                                                ...
                                                INNER JOIN tbl_status on tbl_subject.status = tbl_status.id";
                                                $query_run = mysqli_query($con, $query);
                                                if (mysqli_num_rows($query_run) > 0) {
                                                    foreach ($query_run as $row) {
                                                ?>
                                                <td><?= $row['sub_id']; ?></td>
                                                <td><?= $row['subject_kh']; ?></td>
                                                <!-- <td><a class="btn btn-success btn-sm rounded-pill"><?= $row['status']; ?></a></td> -->
                                                <td>
