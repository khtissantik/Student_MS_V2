            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item menu-open">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="new_grade.php" class="nav-link active">
                      <i class="nav-icon fa fa-plus fa-lg"></i>
            ...
            <div class="col-12">
              ...
              <div class="card ">
                ...
                <div class="card-header p-3" id="font">
                  <h3 class="card-title">កម្រិតសិក្សា</h3>
                  <div class="card-tools">
                    <a><button class="btn btn-primary mr-2 " data-toggle="modal" data-target="#save_grade" type="button"><i class="nav-icon fas fa-plus"></i> បន្ថែមព័ត៌មាន</button></a>
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <th>ល.រ</th>
                        <th>កម្រិតសិក្សា</th>
                        <th>កម្រិតសិក្សាជាអក្សរឡាតាំង</th>
                        <th>សកម្មភាព</th>
                      </tr>
                    </thead>
                    <tbody style="font-size: 14px;">
                      <tr>
                        ...
                        ?>
                            <td><?= $relateds['id']; ?></td>
                            <td><?= $relateds['grade_kh']; ?></td>
                            <td><?= $relateds['grade_en']; ?></td>

                            <td class="project-actions text-left">
                              <a href="edit.php?id=<?= $row['id']; ?>" class="btn btn-info btn-sm text-white"><i class="fas fa-eye"></i></a>
