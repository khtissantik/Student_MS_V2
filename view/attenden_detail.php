...
<body class="hold-transition sidebar-mini ">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header" id="font">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Attendance / វត្តមានសិស្ស</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card ">
                                ...
                                <div class="card-header p-3" id="font">
                                    <h3 class="card-title">វត្តមានសិស្ស</h3>
                                    <div class="card-tools">
                                    <a><button class="btn btn-primary mr-2 " data-toggle="modal" data-target="#create_attenden" type="button"><i class="nav-icon fas fa-plus"></i> បញ្ចូលវត្តមាន</button></a>
                                    </div>
                                </div>
                                <form action="../action/create_attenden.php" method="post">
                                    ...
                                    <div class="card-body p-3" id="font">
                                        ...
                                        <br>
                                        <button type="submit" name="create_attenden" class="btn btn-primary float-right"><i class="fas fa-save"></i> រក្សាទុក</button>
                                        <a href="attenden.php"><button class="btn btn-danger " type="button">ថយក្រោយ</button></a>
                                </form>
                            </div>
                            <!-- /.card-body -->
                        </div>
    ...
    <?php include("../modals/add_attenden.php") ?>
