  ...
  <div class="sidebar mt-1">
    ...
    <nav class="mt-2">
      <ul class="nav nav-flat nav-collapse-hide-child nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false" id="font">
        ...
        <li class="nav-item">
          <a href="index.php" class="nav-link active" role="button">
...
<div class="content-wrapper">
  ...
  <div class="content-header" id="font">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Dashboard / ទំព័រដើម</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text" ​​​ id="font">គ្រូបង្រៀន</span>
                <span class="info-box-number"> <?php
                                                $dash_teacher_query = mysqli_query($con, "SELECT * FROM tbl_teacher ");

                                                $dash_teacher_query_run = mysqli_num_rows($dash_teacher_query);
                                                if ($teacher_total = $dash_teacher_query_run) {
                                                  echo  $teacher_total;
                                                } else {
                                                  echo '<h3>No Data</h3>';
                                                }
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text" id="font">សិស្ស</span>
                <span class="info-box-number"><?php
                                              $dash_teacher_query = mysqli_query($con, "SELECT * FROM tbl_student ");
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              <span class="info-box-icon bg-primary"><i class="fas fa-user-graduate" style="color: #ffffff;"></i></span>

              <div class="info-box-content">
                <span class="info-box-text" id="font">ថ្នាក់រៀន</span>
                <span class="info-box-number"><?php
                                              $dash_teacher_query = mysqli_query($con, "SELECT * FROM tbl_class ");
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              <span class="info-box-icon bg-danger"><i class="fas fa-list-ul"></i></span>

              <div class="info-box-content">
                <span class="info-box-text" id="font">មុខវិជ្ជា</span>
                <span class="info-box-number">
                  <?php
                  $dash_teacher_query = mysqli_query($con, "SELECT * FROM tbl_subject ");
                ...
                <div class="row">
                  <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box">
                      ...
                      <div class="info-box-content">
                        <span class="info-box-text" ​​​ id="font">អ្នកប្រើប្រាស់</span>
                        <span class="info-box-number"> <?php
                                                        $dash_teacher_query = mysqli_query($con, "SELECT * FROM tbl_user ");
                  ...
                  <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box">
                      <span class="info-box-icon bg-teal "><i class="far fa-calendar"></i></span>

                      <div class="info-box-content">
                        <span class="info-box-text" id="font">កាលវិភាគ</span>
                        <span class="info-box-number"><?php
                                                      $dash_teacher_query = mysqli_query($con, "SELECT * FROM tbl_schedule_detail ");
                  ...
                  <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box">
                      <span class="info-box-icon bg-warning"><i class="fas fa-pen" style="color: #ffffff;"></i></span>

                      <div class="info-box-content">
                        <span class="info-box-text" ​ id="font">កត់ចំណាំ</span>
                        <span class="info-box-number"><?php
                                                      $dash_teacher_query = mysqli_query($con, "SELECT * FROM schedule_list");
                  ...
                  <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box">
                      ...
                      <div class="info-box-content">
                        <span class="info-box-text" id="font">វត្តមានសិស្ស</span>
                        <span class="info-box-number">
                        4
                        </span>
                      </div>
